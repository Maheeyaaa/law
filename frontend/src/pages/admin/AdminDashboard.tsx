        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: 400 }}>
          <div style={{ textAlign: "center" }}>
            <div style={{
              ...
              borderTop: "4px solid #1e5fff",
              borderRadius: "50%",
              animation: "spin 1s linear infinite",
              margin: "0 auto 16px",
            }} />
            <p style={{ ...DM, color: "rgba(255,255,255,.4)", fontSize: 13 }}>
              Loading dashboard...
            </p>
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* Total Users */}
        <div
          style={statCard("#4d8aff")}
          onClick={() => navigate("/admin/users")}
          onMouseEnter={e => {
            (e.currentTarget as HTMLDivElement).style.transform = "translateY(-2px)";
            (e.currentTarget as HTMLDivElement).style.boxShadow = "0 12px 40px rgba(0,0,0,.6)";
          }}
          onMouseLeave={e => {
            (e.currentTarget as HTMLDivElement).style.transform = "translateY(0)";
            (e.currentTarget as HTMLDivElement).style.boxShadow = "0 8px 32px rgba(0,0,0,.4)";
          }}
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div>
              <p style={{ ...DM, fontSize: 11, color: "rgba(255,255,255,.4)", textTransform: "uppercase", letterSpacing: "1px", marginBottom: 10 }}>
                Total Users
              </p>
        ...
        <div style={statCard("#34d399")}>
          ...
          <div style={{ marginTop: 16 }}>
            <span style={badge("#34d399")}>
              {stats?.citizens?.total > 0
                ? Math.round((stats.citizens.active / stats.citizens.total) * 100)
                : 0}% of total
            </span>
          </div>
        </div>
      ...
      <div style={{
        ...
        <div style={card}>
          <div style={{
            ...
            <h2 style={{ ...DM, fontSize: 15, fontWeight: 700, color: "#fff", margin: 0 }}>
              👥 Recent Users
            </h2>
            <button
              onClick={() => navigate("/admin/users")}
          ...
          {recentUsers.length === 0 ? (
            <p style={{ ...DM, color: "rgba(255,255,255,.3)", fontSize: 13, textAlign: "center", padding: "24px 0" }}>
              No users yet
            </p>
          ) : (
              ...
              {recentUsers.map((user) => (
                ...
                >
                  ...
                  <div style={{ textAlign: "right", flexShrink: 0 }}>
                    <p style={{ ...DM, fontSize: 10, color: "rgba(255,255,255,.25)", margin: 0 }}>
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <p style={{
                      ...
                      {act.citizen?.name || "Unknown"} · {timeAgo(act.createdAt)}
                    </p>
                  </div>
                </div>
              ))}
