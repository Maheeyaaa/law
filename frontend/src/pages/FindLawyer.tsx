...
export default function FindLawyer() {
  ...
  const fetchCases = async () => {
    try {
      ...
      setCases(
        res.data.cases.filter(
          (c: any) => c.status !== "Resolved" && c.status !== "Closed" && !c.assignedLawyer
        )
      );
    } catch (err) {
      console.error(err);
                      ...
                      <div style={{ display: "flex", alignItems: "flex-start", gap: 14, marginBottom: 12 }}>
                        <div
                          style={{
                            ...
                            height: 48,
                            borderRadius: "50%",
                            background: "linear-gradient(135deg,rgba(0,0,0,0.6),rgba(30,95,255,0.4))",
                            display: "flex",
                            alignItems: "center",
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <p style={{ ...DM, fontSize: 14, fontWeight: 700, color: "#fff" }}>
                            {l.name}
                          </p>
                          <p style={{ ...DM, fontSize: 11, color: ICEB, marginTop: 2 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
              {[
                ...
                >
                  ...
                  <p style={{ fontFamily: "'Bebas Neue',cursive", fontSize: 36, color: "#fff" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  {requests.map((r) => (
                    <div
                      ...
                      onMouseLeave={(e) => {
                        (e.currentTarget as HTMLElement).style.background = "rgba(0,0,0,0.35)";
                        (e.currentTarget as HTMLElement).style.border = "1px solid rgba(255,255,255,.04)";
                      }}
                    >
                      <div style={{ display: "flex", alignItems: "center", gap: 14, flex: 1 }}>
                        ...
                        <div>
                          <p style={{ ...DM, fontSize: 13, fontWeight: 600, color: "#fff" }}>
                            {r.lawyer?.name || "Unknown"}
                          </p>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 12, flexShrink: 0 }}>
                        <span
                          style={{
                            ...
                            padding: "5px 12px",
                            borderRadius: 99,
                            background: `${requestStatusColor(r.status)}15`,
                            border: `1px solid ${requestStatusColor(r.status)}44`,
        ...
        {showProfile && (
          <div style={{ position: "fixed", inset: 0, zIndex: 999, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <div
              ...
              style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,.75)", backdropFilter: "blur(8px)" }}
            />
              ...
              {profileLoading ? (
                ...
                <>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 16 }}>
                    ...
                    <div>
                      <p style={{ ...DM, fontSize: 20, fontWeight: 700, color: "#fff" }}>
                        {selectedLawyer.name}
                      </p>
                      <p style={{ ...DM, fontSize: 12, color: ICEB }}>
                  ...
                  {selectedLawyer.bio && (
                    <div style={{ marginBottom: 24 }}>
                      ...
                      <p style={{ ...DM, fontSize: 12, color: "rgba(255,255,255,.5)", lineHeight: 1.7 }}>
                        {selectedLawyer.bio}
                      </p>
                    </div>
                  )}
                  ...
                  {selectedLawyer.isContactOnly ? (
                    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                      ...
                      {selectedLawyer.proBonoRegistrationNo && (
                        ...
                        >
                          <p style={{ ...DM, fontSize: 9, color: "rgba(255,255,255,.3)", marginBottom: 4 }}>
                    ...
                    <button
                      onClick={() => {
                        setShowProfile(false);
                        openRequestModal(selectedLawyer._id, selectedLawyer.name);
                      }}
                      style={{
                        ...DM,
                        width: "100%",
        ...
        {showRequestModal && (
          <div style={{ position: "fixed", inset: 0, zIndex: 999, display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            >
              ...
              <p style={{ ...DM, fontSize: 18, fontWeight: 700, color: "#fff", marginBottom: 4 }}>
                Send Consultation Request
              </p>
              <p style={{ ...DM, fontSize: 12, color: "rgba(255,255,255,.4)", marginBottom: 24 }}>
                to {requestLawyerName}
              </p>
              ...
              {requestMsg && (
                <div
                  style={{
                    ...DM,
                    background: requestMsg.type === "success" ? "rgba(52,211,153,.1)" : "rgba(255,107,107,.1)",
                    border: `1px solid ${requestMsg.type === "success" ? "rgba(52,211,153,.2)" : "rgba(255,107,107,.2)"}`,
                    borderRadius: 8,
                    padding: "10px 14px",
                    fontSize: 12,
                    color: requestMsg.type === "success" ? "#34d399" : "#ff6b6b",
                    marginBottom: 16,
                  }}
                >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                <div>
                  <p style={{ ...DM, fontSize: 10, color: "rgba(255,255,255,.4)", marginBottom: 6, textTransform: "uppercase", letterSpacing: "1px" }}>
                    Link to Request (Optional)
                  </p>
                  <select
                    value={requestCaseId}
                    onChange={(e) => setRequestCaseId(e.target.value)}
                    style={{
                      ...DM,
                      width: "100%",
                      background: "rgba(0,0,0,0.4)",
                ...
                <button
                  ...
                  style={{
                    ...DM,
                    background: sending ? "rgba(0,0,0,0.3)" : "rgba(0,0,0,0.55)",
                  ...
                  onMouseEnter={(e) => {
                    if (!sending) (e.currentTarget as HTMLElement).style.transform = "translateY(-3px)";
                  }}
                  onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.transform = "translateY(0)")}
                >
