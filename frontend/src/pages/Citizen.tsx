              ...
              <Plate style={{ padding: "24px 28px", marginBottom: 28, cursor: "pointer", transition: "transform .2s ease" }}>
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
                    <div style={{ width: 52, height: 52, borderRadius: 14, background: "linear-gradient(135deg, #1e5fff, #4d8aff)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24, flexShrink: 0, boxShadow: "0 0 20px rgba(30,95,255,.4)" }}>
                      🤖
                    </div>
                    <div>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
                    ...
                    <div style={{ width: 36, height: 36, borderRadius: 10, background: BLUE, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, color: "#fff", flexShrink: 0, boxShadow: SH_CARD, marginLeft: 8 }}>→</div>
                  </div>
                </div>
              </Plate>
